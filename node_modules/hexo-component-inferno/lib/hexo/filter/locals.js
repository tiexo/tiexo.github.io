  ...
  hexo.extend.filter.register('template_locals', locals => {
    ...
    if (page) {
      if (page.layout in ALTERNATIVE_CONFIG) {
        ...
        locals.config = Object.assign({}, locals.config, Object.getPrototypeOf(locals).theme || locals.theme, ALTERNATIVE_CONFIG[page.layout]);
      } else {
        // site config already merged into theme config in hexo/lib/hexo/index.js#Hexo.prototype._generateLocals()
        locals.config = Object.assign({}, locals.config, Object.getPrototypeOf(locals).theme || locals.theme);
      } // merge page configs
