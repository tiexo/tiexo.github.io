...
function (_Component) {
  ...
  function AddToAny() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AddToAny).apply(this, arguments));
  }
...
module.exports = cacheComponent(AddToAny, 'share.addtoany', function (props) {
  return {};
});