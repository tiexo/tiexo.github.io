...
function (_Component) {
  ...
  function BaiduAnalytics() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(BaiduAnalytics).apply(this, arguments));
  }
...
module.exports = cacheComponent(BaiduAnalytics, 'plugin.baiduanalytics', function (props) {
  var head = props.head,
      plugin = props.plugin;
