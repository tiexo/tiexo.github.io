...
function (_Component) {
  ...
  function Mathjax() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Mathjax).apply(this, arguments));
  }
...
module.exports = cacheComponent(Mathjax, 'plugin.mathjax', function (props) {
  var head = props.head,
      helper = props.helper;
