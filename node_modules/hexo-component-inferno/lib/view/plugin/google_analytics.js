...
function (_Component) {
  ...
  function GoogleAnalytics() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(GoogleAnalytics).apply(this, arguments));
  }
...
module.exports = cacheComponent(GoogleAnalytics, 'plugin.googleanalytics', function (props) {
  var head = props.head,
      plugin = props.plugin;
