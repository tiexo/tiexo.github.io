...
function (_Component) {
  ...
  function DisqusJs() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DisqusJs).apply(this, arguments));
  }
...
module.exports = cacheComponent(DisqusJs, 'comment.disqusjs', function (props) {
