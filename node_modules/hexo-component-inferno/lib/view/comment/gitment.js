...
function (_Component) {
  ...
  function Gitment() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Gitment).apply(this, arguments));
  }
...
module.exports = cacheComponent(Gitment, 'comment.gitment', function (props) {
