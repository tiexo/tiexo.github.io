...
function (_Component) {
  ...
  function Archives() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Archives).apply(this, arguments));
  }
...
module.exports = cacheComponent(Archives, 'widget.archives', function (props) {
