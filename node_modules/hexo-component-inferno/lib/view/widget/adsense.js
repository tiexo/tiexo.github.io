...
function (_Component) {
  ...
  function AdSense() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AdSense).apply(this, arguments));
  }
...
module.exports = cacheComponent(AdSense, 'widget.adsense', function (props) {
