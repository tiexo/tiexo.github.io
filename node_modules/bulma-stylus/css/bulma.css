...
.button, .delete, .file, .breadcrumb, .modal-close, .pagination-previous, .pagination-next, .pagination-link, .pagination-ellipsis, .tabs, .is-unselectable {
...
.input:hover, .textarea:hover, .select select:hover, .input.is-hovered, .textarea.is-hovered, .select select.is-hovered {
  border-color: #b5b5b5;
}

.input:focus, .textarea:focus, .select select:focus, .input.is-focused, .textarea.is-focused, .select select.is-focused, .input:active, .textarea:active, .select select:active, .input.is-active, .textarea.is-active, .select select.is-active {
  border-color: #3273dc;
  box-shadow: 0 0 0 0.125em rgba(50, 115, 220, 0.25);
}

.input[disabled], .textarea[disabled], .select select[disabled], fieldset[disabled] .input, fieldset[disabled] .textarea, fieldset[disabled] .select select {
  background-color: #f5f5f5;
  border-color: #f5f5f5;
  box-shadow: none;
  color: #7a7a7a;
...
.input[disabled]::-moz-placeholder, .textarea[disabled]::-moz-placeholder, .select select[disabled]::-moz-placeholder, fieldset[disabled] .input::-moz-placeholder, fieldset[disabled] .textarea::-moz-placeholder, fieldset[disabled] .select select::-moz-placeholder {
  color: rgba(122, 122, 122, 0.3);
}

.input[disabled]::-webkit-input-placeholder, .textarea[disabled]::-webkit-input-placeholder, .select select[disabled]::-webkit-input-placeholder, fieldset[disabled] .input::-webkit-input-placeholder, fieldset[disabled] .textarea::-webkit-input-placeholder, fieldset[disabled] .select select::-webkit-input-placeholder {
  color: rgba(122, 122, 122, 0.3);
}
...
.input[disabled]:-ms-input-placeholder, .textarea[disabled]:-ms-input-placeholder, .select select[disabled]:-ms-input-placeholder, fieldset[disabled] .input:-ms-input-placeholder, fieldset[disabled] .textarea:-ms-input-placeholder, fieldset[disabled] .select select:-ms-input-placeholder {
  color: rgba(122, 122, 122, 0.3);
}
...
.is-white.input:focus, .is-white.textarea:focus, .is-focused.is-white.input, .is-focused.is-white.textarea, .is-white.input:active, .is-white.textarea:active, .is-active.is-white.input, .is-active.is-white.textarea {
  box-shadow: 0 0 0 0.125em rgba(255, 255, 255, 0.25);
}
...
.is-black.input:focus, .is-black.textarea:focus, .is-focused.is-black.input, .is-focused.is-black.textarea, .is-black.input:active, .is-black.textarea:active, .is-active.is-black.input, .is-active.is-black.textarea {
  box-shadow: 0 0 0 0.125em rgba(10, 10, 10, 0.25);
}
...
.is-light.input:focus, .is-light.textarea:focus, .is-focused.is-light.input, .is-focused.is-light.textarea, .is-light.input:active, .is-light.textarea:active, .is-active.is-light.input, .is-active.is-light.textarea {
  box-shadow: 0 0 0 0.125em rgba(245, 245, 245, 0.25);
}
...
.is-dark.input:focus, .is-dark.textarea:focus, .is-focused.is-dark.input, .is-focused.is-dark.textarea, .is-dark.input:active, .is-dark.textarea:active, .is-active.is-dark.input, .is-active.is-dark.textarea {
  box-shadow: 0 0 0 0.125em rgba(54, 54, 54, 0.25);
}
...
.is-primary.input:focus, .is-primary.textarea:focus, .is-focused.is-primary.input, .is-focused.is-primary.textarea, .is-primary.input:active, .is-primary.textarea:active, .is-active.is-primary.input, .is-active.is-primary.textarea {
  box-shadow: 0 0 0 0.125em rgba(0, 209, 178, 0.25);
}
...
.is-link.input:focus, .is-link.textarea:focus, .is-focused.is-link.input, .is-focused.is-link.textarea, .is-link.input:active, .is-link.textarea:active, .is-active.is-link.input, .is-active.is-link.textarea {
  box-shadow: 0 0 0 0.125em rgba(50, 115, 220, 0.25);
}
...
.is-info.input:focus, .is-info.textarea:focus, .is-focused.is-info.input, .is-focused.is-info.textarea, .is-info.input:active, .is-info.textarea:active, .is-active.is-info.input, .is-active.is-info.textarea {
  box-shadow: 0 0 0 0.125em rgba(50, 152, 220, 0.25);
}
...
.is-success.input:focus, .is-success.textarea:focus, .is-focused.is-success.input, .is-focused.is-success.textarea, .is-success.input:active, .is-success.textarea:active, .is-active.is-success.input, .is-active.is-success.textarea {
  box-shadow: 0 0 0 0.125em rgba(72, 199, 116, 0.25);
}
...
.is-warning.input:focus, .is-warning.textarea:focus, .is-focused.is-warning.input, .is-focused.is-warning.textarea, .is-warning.input:active, .is-warning.textarea:active, .is-active.is-warning.input, .is-active.is-warning.textarea {
  box-shadow: 0 0 0 0.125em rgba(255, 221, 87, 0.25);
}
...
.is-danger.input:focus, .is-danger.textarea:focus, .is-focused.is-danger.input, .is-focused.is-danger.textarea, .is-danger.input:active, .is-danger.textarea:active, .is-active.is-danger.input, .is-active.is-danger.textarea {
  box-shadow: 0 0 0 0.125em rgba(241, 70, 104, 0.25);
}
...
.hero.is-medium +tablet .hero-body {
  padding: 9rem 1.5rem;
}

.hero.is-large +tablet .hero-body {
