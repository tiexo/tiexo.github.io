...
module.exports = class extends Component {
    render() {
        ...
        return <Fragment>
            ...
            <script src={url_for('https://cdn.jsdelivr.net/gh/tiexo/tiexo.github.io/js/column.js')}></script>
            <Plugins site={site} config={config} page={page} helper={helper} head={false} />
            <script src={url_for('https://cdn.jsdelivr.net/gh/tiexo/tiexo.github.io/js/main.js')} defer></script>
        </Fragment>;
    }
};